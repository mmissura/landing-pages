  ...
  return (
    <div className="w-full overflow-x-hidden bg-map">
      <div className="bg-black">
        <h1 className="text-4xl text-center font-bold 2xl:text-6xl xl:text-6xl lg:text-6xl mt-10 text-gray-500 p-4">
        Landing pages personalizadas para seu negócio!
        </h1>
        
        <div className="grid grid-rows-12 gap-7 2xl:my-20 xl:my-20 lg:my-20 my-12">
          
          <h2 className='text-xl text-center font-bold 2xl:text-4xl xl:text-4xl lg:text-2xl mb-8
           text-orange-500 px-12 p-6'>O que é uma Landing Page?</h2>
           
          <p className='text-xl text-center 2xl:text-2xl xl:text-2xl lg:text-2xl mb-8 text-white px-12 p-4'>
          ...
          <div className='flex flex-row justify-center items-center flex-wrap gap-3 gap-x-6 p-6'>
            <div>
              <h2 className='text-xl text-center font-bold 2xl:text-2xl xl:text-4xl lg:text-2xl justify-center items-center
            mb-8 text-orange-500'>Principais vantagens de uma Landing Page</h2>
            </div>
            
            <div className='text-xl text-center 2xl:text-2xl xl:text-4xl lg:text-2xl 2xl:grid grid-col w-2/3
            justify-center items-center border-4 border-gray-400 p-6'>

              <h2 className='text-xl text-center 2xl:text-2xl xl:text-2xl lg:text-2xl 
            mb-8 text-green-300 px-12'>Gerar Leads</h2>
              ...
              mb-8 text-green-300 px-12'>Impulsionar as vendas</h2>
              ...
              <h2 className='text-xl text-center 2xl:text-2xl xl:text-3xl lg:text-2xl 
              mb-8 text-green-300 px-12'>Melhorar a conversão</h2>
              ...
              <h2 className='text-xl text-center 2xl:text-2xl xl:text-3xl lg:text-2xl 
              mb-8 text-green-300 px-12'>Medir o sucesso</h2>
              ...
              <h2 className='text-xl text-center 2xl:text-2xl xl:text-3xl lg:text-2xl 
              mb-8 text-green-300 px-12'>Fornecer informação</h2>
            ...
            <h2 className="text-2xl text-center 2xl:text-4xl xl:text-4xl lg:text-2xl mt-8 mb-8 text-blue-500 px-12">
